      ...
      <div>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
            <div className="bg-[#1a1649] relative p-6 w-96 flex flex-col items-center rounded-lg shadow-lg">
              <p className="text-lg text-white font-semibold">YOU WON</p>
              {/* handle the amount  */}
              <p className="text-xl font-bold text-[#fdbf15]">
                {prize.split(" ")[0]}
              </p>
              ...
              {/* gif for modal */}
              <img src={gift} alt="Gift" className="h-60" />
              <button
                className="bg-gray-400 absolute right-4 top-3 rounded-full text-white p-2"
